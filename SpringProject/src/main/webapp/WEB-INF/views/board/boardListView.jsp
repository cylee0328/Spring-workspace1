...
<body>
	...
	<div class="content">
		...
		<div class="innerOuter" style="padding: 5% 10%;">
				...
				<c:forEach items="${list }" var="b">
					...
					<td>
						<c:if test="${!empty b.thumbnail }">
							<img class="list-thumbnail" src="${contextPath }${b.thumnnail}">
						</c:if>
						${b.boardTitle }
					</td>
					<td>${b.boardWriter }</td>
			...
			<form id="searchForm" action="${boardCode }" method="get" align="cetner">
				<div class="select">
				...
				<button type="submit"  class="serachBtn btn btn-secondary">검색</button>
			</form>			
