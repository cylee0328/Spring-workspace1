...
public class FileDeleteScheduler {
	...
	// 1. BOARD_IMG 테이블 안에 있는 이미지목록들을 모두 조회하여
	// 2. images/boardT 디렉토리안에있는 이미지들과 대조하여
	...
	public void deleteFile() {
		...
		// 3) 두 목록을 비교해서 일치하지 않는 파일 삭제(삭제 시 File클래스의 delete()활용)
		if(!list.isEmpty()) {
			// server : C:\Users\CYLEE\Spring-workspace1\SpringProject\src\main\webapp\resources\images\boardT\20230512212330615920.jpg
			// list : 20230512212330623484.jpg
